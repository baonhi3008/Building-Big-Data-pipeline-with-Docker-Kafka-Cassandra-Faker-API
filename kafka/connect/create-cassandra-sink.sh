...
curl -s \
  ...
  "config": {
    ...
    "contactPoints": "cassandradb",
    "loadBalancing.localDc": "datacenter1",
    "topic.faker.kafkapipeline.fakerdata.mapping": "name=value.name, address=value.address, country=value.country, credit_card_number=value.credit_card_number, email=value.email, i_bank=value.i_bank, job=value.job, phone_number=value.phone_number, swift=value.swift, year=value.year",
...
curl -s \
  ...
  "config": {
    ...
    "contactPoints": "cassandradb",
    "loadBalancing.localDc": "datacenter1",
    "topic.mimesis.kafkapipeline.mimesisdata.mapping": "chef=value.chef, chef_nationality=value.chef_nationality, dish=value.dish, drink=value.drink, fruit=value.fruit, level=value.level, quote=value.quote, spices=value.spices, vegetable=value.vegetable",
